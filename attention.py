...
class CrossAttention(nn.Module):
    def __init__(
        ...
        *,
        ...
        """
        (adapted from https://github.com/kyegomez/zeta/blob/master/zeta/nn/attention/cross_attention.py)
    ...
    def forward(self, x, context, mask=None):
        ...
        if exists(mask):
            ...
            mask = F.pad(mask, (1, 0, 0, 0), value=True)
        ...
        return self.to_out(out), attn.detach() # return attention weights
